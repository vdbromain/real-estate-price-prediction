...
### 1) Collecting the urls from each page
...
### 2) Scrapping all the content of each url in the built csv file
...
### 3) Sorting and storing the data in a dictionary
...
### 4) Storing the dictionary in a pandas' dataframe
...
## 3) Conclusions on the modeling part :
...
#### a) Building a form's example to receive the datas
...
#### b) Collecting and preprocessing datas the user give me
...
<img title="" src="Visuals/Real_Estate_Pipeline.png" alt="Mean renting price" data-align="center">

## 3) Deploying the API on render.com
